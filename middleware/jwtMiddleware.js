...
const jwtmiddlewear=(req,res,next)=>{
    ...
    try{
        ...
        const jwtResponse = jwt.verify(token2,"supersecretkey123")
        ...
        req.payload= jwtResponse.partnerid //here we use userId because we get id in userId key in the controller
